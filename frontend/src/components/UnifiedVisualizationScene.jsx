...
const UnifiedVisualizationScene = forwardRef(
  ({ cameraMode = "OVERVIEW", missionMode = true, onPositionUpdate, onMissionUpdate}, ref) => {
    ...
    const obstacleBuildings = [
      { x: -300, y: 0, z: 100, radius: 155 },
      { x: 250, y: 0, z: 800, radius: 155 },
      { x: -100, y: 0, z: 1400, radius: 155 },
      { x: 1800, y: 0, z: 430, radius: 155 },
      { x: 2600, y: 0, z: 460, radius: 155},
    ];
...
useEffect(() => {
  ...
  try {
    ...
    if (transform) {
      const rawObstacles = obstacleBuildings.map((obstacle) =>
